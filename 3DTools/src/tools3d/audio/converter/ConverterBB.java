...
public class ConverterBB
{
	...
	public void convert(String sourceName, ByteBuffer dest,
			...
			throws JavaLayerException
		{
			...
			try {
				...
				convert(in, dest, progressListener, decoderParams);
				in.close();
	...
	public synchronized void convert(InputStream sourceStream, ByteBuffer dest,
		ProgressListener progressListener, Decoder.Params decoderParams)
		throws JavaLayerException
	{
				...
				for (; frame<frameCount; frame++)
				{
					try
					{
						...
						if (output==null)
						{
							...
							output = new WaveByteBufferObuffer(channels, freq, dest);

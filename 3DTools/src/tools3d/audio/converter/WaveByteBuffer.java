 ...
 */
public class WaveByteBuffer extends RiffByteBuffer
{
	...
	public class WaveFileSample
	{
		...
		{
			chan = new short[WaveByteBuffer.MAX_WAVE_CHANNELS];
		}
	}
	...
	*
	*/
	public int OpenForWrite(ByteBuffer os, int SamplingRate, short BitsPerSample, short NumChannels)
	{
		// Verify parameters...
		if ((os == null) || (BitsPerSample != 8 && BitsPerSample != 16) || NumChannels < 1 || NumChannels > 2)
		{
			return DDC_INVALID_CALL;
		}
	...
	*/
	public int OpenForWrite(ByteBuffer os, WaveByteBuffer OtherWave)
	{
		return OpenForWrite(os, OtherWave.SamplingRate(), OtherWave.BitsPerSample(), OtherWave.NumChannels());
	}

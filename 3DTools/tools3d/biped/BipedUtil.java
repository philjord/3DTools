...
public class BipedUtil
{
	...
	public static double getYaw(Vector3d dir)
	{
	...
	public static double getPitch(Vector3d dir)
	{
	...
	public static Vector3d rotate(Vector3d p1, Quat4d q)
	{
		...
		p2.x = q.w * q.w * p1.x + 2 * q.y * q.w * p1.z - 2 * q.z * q.w * p1.y + q.x * q.x * p1.x + 2 * q.y * q.x * p1.y + 2 * q.z * q.x * p1.z - q.z
				* q.z * p1.x - q.y * q.y * p1.x;

		p2.y = 2 * q.x * q.y * p1.x + q.y * q.y * p1.y + 2 * q.z * q.y * p1.z + 2 * q.w * q.z * p1.x - q.z * q.z * p1.y + q.w * q.w * p1.y - 2 * q.x
				* q.w * p1.z - q.x * q.x * p1.y;

		p2.z = 2 * q.x * q.z * p1.x + 2 * q.y * q.z * p1.y + q.z * q.z * p1.z - 2 * q.w * q.y * p1.x - q.y * q.y * p1.z + 2 * q.w * q.x * p1.y - q.x
				* q.x * p1.z + q.w * q.w * p1.z;
